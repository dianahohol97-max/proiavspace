...
- Freemium: безкоштовно 3 ГБ назавжди, без картки; тарифи Базовий 79₴/міс (100 ГБ), Плюс 319₴ (500 ГБ), Максимальний 559₴ (1 ТБ). Річна оплата = 2 місяці безкоштовно. Кількість галерей не обмежена.
